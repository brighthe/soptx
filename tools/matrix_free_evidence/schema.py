...
#: 升到 4: ``parameters.material`` 改记维度无关的 ``hypothesis``/``lame_lambda``/
#: ``shear_modulus``, 二维原先记的是 ``youngs_modulus``/``poisson_ratio``; 同时
...
#: references that the MatVec, positive-definiteness and explicit-solution
#: gates consume.
