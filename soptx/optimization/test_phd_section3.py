...
class DensityTopOptTest(BaseLogged):
    ...
    @run.register('test_subsec3_6_4_simply_supported_bridge_2d')
    def run(self) -> Union[TensorLike, OptimizationHistory]:
        t = -1
        E, nu = 350, 0.3
        domain = [0, 120, 0, 40]
        ...
        from soptx.model.simply_supported_bridge_2d_lfem import SimplySupportedBridge2d
    ...
    def run(self) -> Union[TensorLike, OptimizationHistory]:
        ...
        # base_dir = current_file.parent.parent / 'vtu' 
        # base_dir = str(base_dir)
        # save_path = Path(f"{base_dir}/subsec3_6_5_canti_3d/json")
        # save_path.mkdir(parents=True, exist_ok=True)    
