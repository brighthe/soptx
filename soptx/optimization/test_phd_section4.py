...
class DensityTopOptTest(BaseLogged):
    ...
    @run.register('test_subsec4_6_2_mbb2d')
    def run(self) -> Union[TensorLike, OptimizationHistory]: 
        # current_file = Path(__file__)
        # base_dir = current_file.parent.parent / 'vtu' 
        # save_path = base_dir / 'subsec4_6_2_mbb2d' / 'json'
        # save_path.mkdir(parents=True, exist_ok=True)

        # print(list(save_path.glob('history_*.json')))
    
        # histories = load_history_data(save_path, labels=['convergence_stop_k1'])

        # plot_optimization_history(histories['convergence_stop_k1'], save_path=f'{save_path}/convergence.png')
        ...
        base_dir = current_file.parent.parent / 'vtu'
        base_dir = str(base_dir)
        save_path = Path(f"{base_dir}/test_subsec4_6_2_mbb2d")
        save_path.mkdir(parents=True, exist_ok=True)    
    ...
    @run.register('test_subsec4_6_3_mbb2d')
    def run(self) -> Union[TensorLike, OptimizationHistory]:
        # current_file = Path(__file__)
        # base_dir = current_file.parent.parent / 'vtu' 
        # save_path = base_dir / 'subsec4_6_3_mbb2d' / 'json'
        # save_path.mkdir(parents=True, exist_ok=True)

        # print(list(save_path.glob('history_*.json')))
    
        # histories = load_history_data(save_path, labels=['k4_480'])

        # plot_optimization_history(histories['k4_480'], save_path=f'{save_path}/convergence.png')
        ...
        base_dir = current_file.parent.parent / 'vtu'
        base_dir = str(base_dir)
        save_path = Path(f"{base_dir}/test_subsec4_6_3_mbb2d")
        save_path.mkdir(parents=True, exist_ok=True)    
...
if __name__ == "__main__":
    ...
    test.run.set('test_subsec4_6_2_mbb2d')
